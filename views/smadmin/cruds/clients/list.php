...
if(isset($_GET["del"]) && is_numeric ($_GET["del"])) {
	...
	$action = db::delete("c_clients", array("id" => $_GET["del"]));
	if($action) {
	send("Successfully Deleted", "success", "crud.php?c=clients");
	}else {
...
if(isset($_POST["tableitems"])) {
	...
	foreach($_POST["tableitems"] as $id) {
		$action = db::delete("c_clients", array("id" => $id));
		$action = true;
		if(!$action) {
			send("The item couldn't deleted.", "error");
		}
...
?>
<a class="btn black left" href="?c=clients&p=new">Add</a>
<?php $datatables=TRUE; ?>
	...
	$(document).ready(function() {
		oTable  = $('#crud').dataTable( {
			...
			"fnServerData": function ( sSource, aoData, fnCallback ) {
						aoData.push( { "name": "c", "value": "c_clients" } );
				$.ajax( {
					"dataType": 'json', 
					"type": "GET", 
					"url": sSource, 
			...
			"aoColumns": [
				...
				{"sClass": "textbox order0",  "sTitle": "Bayi ismi", "sType": "string"},
				{"sClass": "textbox order1",  "sTitle": "Bayi yetkilisi", "sType": "string"},
				{"sClass": "textbox order2", "bVisible": false, "sTitle": "Yetkili e-posta adresi", "sType": "string"},
				{"sClass": "textbox order3", "bVisible": false, "sTitle": "Yetkili şifresi", "sType": "string"},
				{"sClass": "textbox order4",  "sTitle": "Bayinin bulunduğu ülke", "sType": "string"},
				{"sClass": "textbox order5", "bVisible": false, "sTitle": "Bayinin bulunduğu şehir", "sType": "string"},
				{"sClass": "textbox order6",  "sTitle": "Bayinin web adresi", "sType": "string"},
				{"sClass": "textbox order7", "bVisible": false, "sTitle": "Otelin e-posta adresi", "sType": "string"},
				{"sClass": "textbox order8", "bVisible": false, "sTitle": "Otelin Telefon Numarası", "sType": "string"},
				{"sClass": "textbox order9",  "sTitle": "Komisyon Değeri", "sType": "string"},
				{"mDataProp": null, "sClass": "control center", "fnRender": function (events) {return '<a href="?c=clients&p=edit&id='+events.aData[0]+'&createnew"><span class="ui-icon ui-icon-newwin"></span></a><a href="?c=clients&p=edit&id='+events.aData[0]+'&viewonly"><span class="ui-icon ui-icon-search"></span></a><a href="?c=clients&p=edit&id='+events.aData[0]+'"><span class="ui-icon ui-icon-pencil"></span></a><a confirm="You have selected 1 entry for permanent deletion. This action cannot be undone." href="?c=clients&del='+events.aData[0]+'"><span class="ui-icon ui-icon-trash"></span></a>';}, "bSortable": false}
			]
		} );
